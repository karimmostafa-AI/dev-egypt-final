    ...
    <footer className="w-full">
      ...
      <section className="w-[1920px] max-w-full mx-auto" style={{ backgroundColor: '#D0011B' }}>
        <div className="px-[200px] py-4 text-white">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 text-center text-[14px]">
            <div>
              <div className="font-medium">Buy Now Pay Later</div>
            </div>
            <div>
              <div className="font-medium">Visit Our Stores Near You</div>
            </div>
            <div>
              <div className="font-medium">Group Orders</div>
            </div>
            <div>
              <div className="font-medium">Shop Our Catalog</div>
              <div className="opacity-90 text-[12px]">BROWSE CATALOG</div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="px-[50px] pt-10 pb-5">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            ...
            <div className="text-[13px]">
              ...
              <ul className="columns-2 gap-8 opacity-80 [column-fill:_balance]"><li>Scrubs for Women</li><li>Scrubs for Men</li><li>Scrubs on Sale</li><li>Maternity Scrubs</li><li>Scrub Jumpsuits</li><li>Scrub Caps & Surgical Hats</li><li>Non Slip Shoes</li><li>Gifts for Nurses</li></ul>
            </div>
          </div>
