...
const Toast = ({ notification, onRemove }: ToastProps) => {
  ...
  return (
    <div className={twMerge(
      'max-w-sm w-full border rounded-lg shadow-lg p-4 mb-4 animate-in slide-in-from-right duration-300',
      getColorClasses()
    )}>
      <div className="flex items-start">
        <div className={twMerge('flex-shrink-0', getIconColorClasses())}>
          {getIcon()}
        </div>
