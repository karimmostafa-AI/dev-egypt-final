...
import { Search, UserPlus, MoreHorizontal, Trash2, Eye, Mail, Phone, Calendar, Download, UserCheck, UserX } from "lucide-react"
...
export default function CustomersPage() {
  ...
  const exportToCSV = () => {
    const csv = [
      ["Name", "Email", "Phone", "Status", "Email Verified", "Registered"],
      ...customers.map(c => [
        c.name,
        c.email,
        c.phone || "",
        c.status ? "Active" : "Inactive",
        c.emailVerification ? "Yes" : "No",
        new Date(c.registration).toLocaleDateString()
      ])
                        ...
                        <TableCell className="text-right">
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end">
                              ...
                              <DropdownMenuItem
                                onClick={() => handleStatusUpdate(customer.$id, !customer.status)}
                              >
                                {customer.status ? (
                                  <>
